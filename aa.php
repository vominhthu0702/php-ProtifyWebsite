...
<head>
  ...
  <?php
  include '../libary/connectprotify.php';
  ?>
  <!--=================================
Meta tags
=================================-->
                    ...
                    <div class="yamm-content">
                      <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                          ...
                          <!--yamm artist info-->
                          <a class="to-page" href="blog.html">View All posts</a>
                        </div>
                        <!--col-->
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          <div class="yamm-artist-album">
                            <h2>Top 5 album</h2>
                            <a href="album-detail.html"><img src="assets/img/albums/10.jpg" alt=""></a> <a href="album-detail.html"><img src="assets/img/albums/11.jpg" alt=""></a> <a href="album-detail.html"><img src="assets/img/albums/12.jpg" alt=""></a> <a href="album-detail.html"><img src="assets/img/albums/13.jpg" alt=""></a>
                          </div>
                        </div>
                        <!--yamm artist album-->
                    ...
                    <div class="yamm-content">
                      <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                          ...
                          <!--\\video-feed-->
                          <a class="to-page" href="videos.html">View All videos</a>
                        </div>
                        <!--col-->
            ...
            <div class="audio-list">
              ...
              <div class="jp-playlist">
                ...
                <ul class="hidden playlist-files">
                  <li data-title="Maroon 5 - Moves Like Jagger" data-artist="ft. Christina" data-mp3="http://www.jplayer.org/audio/mp3/TSP-01-Cro_magnon_man.mp3"></li>
                  <li data-title="Coldplay - Princess Of China" data-artist="ft. Rihanna" data-mp3="http://www.jplayer.org/audio/mp3/TSP-01-Cro_magnon_man.mp3"></li>
                  <li data-title="Lorem Ipsum" data-artist="ft. Rocker" data-mp3="http://www.jplayer.org/audio/mp3/TSP-01-Cro_magnon_man.mp3"></li>
                  <li data-title="New Fish!!!" data-artist="ft. Jailer" data-mp3="http://www.jplayer.org/audio/mp3/TSP-01-Cro_magnon_man.mp3"></li>
                  <li data-title="I wanna grow" data-artist="ft. MeDon" data-mp3="http://www.jplayer.org/audio/mp3/TSP-01-Cro_magnon_man.mp3"></li>
                  <li data-title="do be do" data-artist="ft. scoby" data-mp3="http://www.jplayer.org/audio/mp3/TSP-01-Cro_magnon_man.mp3"></li>
                  <li data-title="We aint smart" data-artist="ft. SomeFool" data-mp3="http://www.jplayer.org/audio/mp3/TSP-01-Cro_magnon_man.mp3"></li>
                </ul>
                <!--Playlist ends-->
            ...
            <div class="col-lg-9 col-md-9 col-sm-9">
              <div class="news-wrapper">
               ...
               // Create connection
                    ...
                    $sql = "SELECT Name,Datetime,Author,Content FROM tbproject";
                  ...
                  <img src="assets/img/news/kpop1.jpg" alt="dummy">  //gọi echo  
                  <h2><a href="https://zingnews.vn/nhan-sac-13-nam-khong-thay-doi-cua-yoona-snsd-post1084956.html"><?php echo $row["Name"] ?></a></h2>
                  <ul>
                    <li<?php echo "Datetime: " . $row["Datetime"] ?>></li>
                    <li><span class="fa fa-comment"></span><?php echo "Tâc giả: " . $row["Author"] ?></li>
                  </ul>
                  <p>
                      <?php echo "Mô tả:" . $row["Content"] ?>
                  </p>
                          <?php
                   }
                    } else {
                ...
                <div class="news-feed">
                  <img src="assets/img/news/kpop2.jpg" alt="dummy">
                  <h2><a href="https://zingnews.vn/nhung-dong-tac-vu-dao-bi-chi-trich-phan-cam-cua-nhom-nu-kpop-post1084813.html"><?php echo $row["Name"] ?></a></h2>
                  <ul>
                    <li>14:15 15/05/2020</li>
                    <li><span class="fa fa-comment"></span>108 comments</li>
                  </ul>
                  <p>Nhiều nhóm nhạc nữ ở Hàn Quốc tận dụng vũ đạo sexy để gây chú ý. Tuy nhiên, cũng vì thế, họ vấp phải sự chỉ trích của khán giả.
                  </p>
                </div>
                <!--\\latest news-->

                <div class="news-feed">
                  <img src="assets/img/news/kpop3.jpg" alt="dummy">
                  <h2><a href="https://zingnews.vn/nam-than-tuong-co-ve-dien-trai-ket-hop-giua-v-bts-va-lee-min-ho-post1084553.html">Nam thần tượng có vẻ điển trai kết hợp giữa V (BTS) và Lee Min Ho</a></h2>
                  <ul>
                    <li>20:37 14/05/2020</li>
                    <li><span class="fa fa-comment"></span>783 comments</li>
                  </ul>
                  <p> Sở hữu visual thu hút cùng tài năng nổi bật, Haruto gây ấn tượng với công chúng ngay từ khi chưa ra mắt.
                  </p>
                </div>
                <!--\\latest news-->
