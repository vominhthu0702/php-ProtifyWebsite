        ...
        <div class="page-title m-b">
          ...
          <div class="dropdown inline">
            ...
            <div class="dropdown-menu">
              <a href="chart.html" class="dropdown-item active">
                By name
              </a>
        ...
        <div data-ui-jp="jscroll" data-ui-options="{
            ...
            nextSelector: 'a.jscroll-next:last'
               ...
               // Create connection
                    ...
                    $sql = "SELECT ArtistID, ArtistName, Desc, ImageFile FROM tb_user";
          ...
          <div class="row row-lg">
                <div class="col-xs-4 col-sm-4 col-md-3">
                	<div class="item">
            			<div class="item-media rounded ">
            				<a href="artist.detail.php" class="item-media-content" style="background-image: url('images/a4.jpg');"></a>
            			</div>
            			<div class="item-info text-center">
            				<div class="item-title text-ellipsis">
            					<a href="artist.detail.html"></a>
                ...
                <div class="col-xs-4 col-sm-4 col-md-3">
                	<div class="item">
            			...
            			<div class="item-info text-center">
            				<div class="item-title text-ellipsis">
            					<a href="artist.detail.html"><?php echo $row['ArtistName'] ?></a>
